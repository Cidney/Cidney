@{
    ...
    FunctionsToExport = 'Pipeline:','Stage:','Do:','On:','When:', 'Register-JobCommand', 'Get-RegisteredJobCommand', 'Get-RegisteredJobModule'
    FileList = '.\Keywords\Pipeline.ps1', '.\Keywords\Stage.ps1', '.\Keywords\On.ps1', '.\Keywords\Do.ps1', '.\Keywords\On.ps1', '.\Keywords\When.ps1'
    AliasesToExport = '*'
    PrivateData = ''
}
